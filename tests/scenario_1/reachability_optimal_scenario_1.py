...
from discretize_helper_scenario_1 import *
import sys
sys.path.append("../../src")
...
# Define Parameters for robot and safe set
U_max = 1.0
d_max = 0.6
scenario_num = 1
...
Safe_Set_Series = Safe_Set_Series2D(centroids=centroids,radii=radii_comb)
